...
print(straight)
```
length of path (straight line between endpoints) divided by the actual distance traveled means that a larger number is a more straight path. therefore, Panther 6 had the most tortuous path (such a goal-oriented queen) and panther one had the most winding path (thats okay too, king, we cant all be expected to know what we want in life right away).
