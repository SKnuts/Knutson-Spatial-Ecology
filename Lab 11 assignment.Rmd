...
$\color{red}{\text{What I was looking for is that speeds can be used to create a pool of potential steps even when the time between fixes isn't constant. +4}}$
...
$\color{red}{\text{Both correct and wise. +5}}$
...
$\color{red}{\text{Close enough. This was a poor question on my part. +5}}$